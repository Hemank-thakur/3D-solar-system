...
function createMaterialArray() {
  const skyboxImagepaths = ['./images/skybox/space_ft.png', './images/skybox/space_bk.png', './images/skybox/space_up.png', './images/skybox/space_dn.png', './images/skybox/space_rt.png', './images/skybox/space_lf.png']
...
function init() {
  ...
  setSkyBox();
  planet_earth = loadPlanetTexture("./images/earth_hd.jpg", 4, 100, 100, 'standard');
  planet_sun = loadPlanetTexture("./images/sun_hd.jpg", 20, 100, 100, 'basic');
  planet_mercury = loadPlanetTexture("./images/mercury_hd.jpg", 2, 100, 100, 'standard');
  planet_venus = loadPlanetTexture("./images/venus_hd.jpg", 3, 100, 100, 'standard');
  planet_mars = loadPlanetTexture("./images/mars_hd.jpg", 3.5, 100, 100, 'standard');
  planet_jupiter = loadPlanetTexture("./images/jupiter_hd.jpg", 10, 100, 100, 'standard');
  planet_saturn = loadPlanetTexture("./images/saturn_hd.jpg", 8, 100, 100, 'standard');
  planet_uranus = loadPlanetTexture("./images/uranus_hd.jpg", 6, 100, 100, 'standard');
  planet_neptune = loadPlanetTexture("./images/neptune_hd.jpg", 5, 100, 100, 'standard');
...
init();
animate(1); // Initialize with time 0